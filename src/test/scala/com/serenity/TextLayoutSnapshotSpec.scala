...
class TextLayoutSnapshotSpec extends AnyFlatSpec with Matchers:
  ...
  // CharWidth's East Asian Width handling (already covered by CharWidthSpec).

  it should "break between adjacent CJK ideographs with no whitespace, per UAX#14" in {
    val font = new java.awt.Font(java.awt.Font.MONOSPACED, java.awt.Font.PLAIN, 12)
