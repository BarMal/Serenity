...
object CommandRunnerSettingsGroups:
  ...
  def build(
    ...
    val companionSpriteEnabledItem = CommandRunnerSettingsAppearanceItems.companionSpriteEnabledOptionItem(optionSelections)
    ...
    val renderDamageGranularityItem = CommandRunnerSettingsMotionItems.renderDamageGranularityOptionItem(optionSelections)
    ...
    val visualLineNavigationItem    = CommandRunnerSettingsTextDisplayItems.visualLineNavigationOptionItem(optionSelections)
    ...
    val commandRunnerKeyHintsItem = CommandRunnerSettingsTextDisplayItems.commandRunnerKeyHintsOptionItem(optionSelections)
