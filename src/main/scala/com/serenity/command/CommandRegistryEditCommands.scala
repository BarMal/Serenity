...
/** Text editing and rich-text formatting commands. Split out of `CommandRegistry.defaultCommands` to keep both
  * under the architecture size targets -- see that method's doc.
  */
