...
/** Dispatches reducer effects through the collaborators required for each effect family. */
final private[manager] class StateManagerEffectInterpreter(
    dependencies: StateManagerEffectInterpreter.Dependencies
):
...
private[manager] object StateManagerEffectInterpreter:
