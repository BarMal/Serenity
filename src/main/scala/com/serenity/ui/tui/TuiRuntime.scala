...
object TuiRuntime:
  ...
  private def renderFullFn(surfaceHolder: SurfaceHolder, shell: TerminalShell): AppRuntime.RenderFn =
  ...
  private def renderCursorOnlyFn(surfaceHolder: SurfaceHolder, shell: TerminalShell): AppRuntime.RenderFn =
