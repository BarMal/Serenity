...
private[config] object ConfigFieldsDocumentsAndCommandRunner:
  ...
  val fields: List[ConfigField[?]] = List(
    ...
    named(
      "editor.default_document_mode",
      "defaultDocumentMode",
      "document.default_mode",
      "document.default.mode",
      "document_default_mode"
    )(
      enumerated(
    ...
    field("workspace.show_all_settings", "app.show_all_settings", "app_show_all_settings")(boolean)(
      _.showAllSettingsRegardlessOfMode,
      (config, value) => config.withShowAllSettingsRegardlessOfMode(value)
    ),
    named(
      "workspace.minimum_pane_width",
      "minimumPaneWidth",
      "editor.minimum_pane_width",
      "editor.minimum.pane.width",
      "editor_minimum_pane_width"
    )(
      int
    )(_.editorConfig.minimumPaneWidth, (config, value) => config.withMinimumPaneWidth(value)),
    named("editor.wheel_scroll_lines", "wheelScrollLines", "input.wheel_scroll_lines", "input_wheel_scroll_lines")(int)(
    ...
    // -- Command runner --------------------------------------------------------------------------------------------------
    field(
      "ui.command_runner.visible_rows",
      "command_runner.visible_rows",
      "command.runner.visible.rows",
      "command_runner_visible_rows"
    )(
      int
        .filtered(rows =>
    ...
    field(
      "ui.command_runner.item_gap_rows",
      "command_runner.item_gap_rows",
      "command.runner.item.gap.rows",
      "command_runner_item_gap_rows"
    )(
      double
        .filtered(rows =>
    ...
    field(
      "ui.command_runner.cursor_gap_rows",
      "command_runner.cursor_gap_rows",
      "command.runner.cursor.gap.rows",
      "command_runner_cursor_gap_rows"
    )(
      double
        .filtered(rows =>
    ...
    field(
      "ui.command_runner.cursor_peek.placement",
