...
object ConfigFileFormat:
  ...
  private val layout: List[Entry] = List(
    ...
    comment("Companion sprite: a small pixel-art character idling in a pinned pane"),
    ...
    comment("Window sitter: the small character that reacts to typing in the window chrome"),
    field("motion.window_sitter.enabled"),
    field("motion.window_sitter.action"),
    field("motion.window_sitter.frames"),
    field("motion.window_sitter.active_ticks"),
    field("motion.window_sitter.fast_active_ticks"),
    field("motion.window_sitter.fast_typing_threshold_ms"),
    blank,
    comment(
